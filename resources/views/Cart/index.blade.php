    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateTotal() {
                ...
                // Ambil cost dari shipping option yang dipilih
            ...
            shippingSelect.addEventListener('change', updateTotal); // Update saat metode pengiriman diganti
    
            // Jalankan updateTotal pertama kali kalau ada item sudah diceklis
            updateTotal();
        });
    </script>
